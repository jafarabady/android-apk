"""
Django settings for android_apk project.
...
SECRET_KEY = 'django-insecure-w3&(&&!q8*qs$**nssveu5!($###-6%9l7k9%bd%0q15mpr!60'
...
WSGI_APPLICATION = 'android_apk.wsgi.application'
